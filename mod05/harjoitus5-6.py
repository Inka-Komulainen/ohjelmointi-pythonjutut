...
i = 1
iYmpyraN = 0 # yllä mainitun kaavan n
iKaikkiN = int(input("Monella pisteellä piin likiarvo lasketaan: ")) # yllä mainitun kaavan N
...
fPii = 4 * iYmpyraN / iKaikkiN # laskee piin likiarvon eli (4 * n/N)
